...
tar -xzvf istio-1.5.0-linux.tar.gz

cd istio-1.5.0
echo 'export PATH="$PATH:/home/ubuntu/istio-1.5.0/bin"' >> ~/.profile
```
...
```
kubectl apply -f ~/istio-1.5.0/install/kubernetes/helm/istio/templates/crds.yaml
```
...
```
kubectl apply -f ~/istio-1.5.0/install/kubernetes/istio-demo.yaml
```
